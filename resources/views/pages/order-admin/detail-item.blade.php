...
@section('content')
    ...
    <div class="container-fluid pt-4 px-4">
        <div class="bg-light rounded h-100 p-4">
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <img src="{{ asset(Str::replace(url('/') . '/img/barang/', '', '/img/barang/' . $data_barang->foto_barang)) }}"
                        width="100%" style="aspect-ratio:9/16;object-fit:cover;" alt="">
                </div>
                <div class="col-12 col-lg-8">
                    <div class="top-text">
                        <h2 class="text-uppercase">{{ $data_barang->nama_barang }}</h2>
                        <h4 class="text-danger">Rp.{{ number_format($data_barang->harga_barang, 0, ',', '.') }},00</h4>
                    </div>
                        ...
                        <table class="table table-striped">
                            <tbody>
                                <tr>
                                    ...
                                    <th scope="col">{{ $data_barang->kode_barang }}</th>
                                </tr>
                                <tr>
                                    <th scope="col">Jenis Barang</th>
                                    <th scope="col">{{ $data_barang->jenis_barang->nama }}</th>
                                </tr>
                                <tr>
                                    <th scope="col">Merek Barang</th>
                                    <th scope="col">{{ $data_barang->merek_barang->nama }}</th>
                                </tr>
                                <tr>
                                    <th scope="col">Stok Barang</th>
                                    <th scope="col">{{ $data_barang->stok_barang }}</th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
